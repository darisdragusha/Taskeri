...
async def create_task(task_data: TaskCreate, controller: TaskController = Depends(), user=Depends(verify_user)):
    """
    Create a new task.
...
async def get_task(task_id: int, controller: TaskController = Depends(), user=Depends(verify_user)):
    """
...
async def get_task_details(task_id: int, controller: TaskController = Depends(), user=Depends(verify_user)):
    """
...
async def get_tasks_by_project(project_id: int, controller: TaskController = Depends(), user=Depends(verify_user)):
    """
...
async def get_tasks_by_user(user_id: int, controller: TaskController = Depends(), user=Depends(verify_user)):
    """
...
async def update_task(task_id: int, task_data: TaskUpdate, controller: TaskController = Depends(), user=Depends(verify_user)):
    """
...
async def delete_task(task_id: int, controller: TaskController = Depends(), user=Depends(verify_user)):
    """
    Delete a task.
...
async def get_task_statistics(controller: TaskController = Depends(), user=Depends(verify_user)):
    """
